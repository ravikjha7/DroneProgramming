...
sensitivity = 3  # if number is high less sensitivity
...
def thresholding(img):
    ...
    lower = np.array([hsVals[0], hsVals[1], hsVals[2]])
    upper = np.array([hsVals[3], hsVals[4], hsVals[5]])
